...
public class EditItemItemLinkRepository extends AbstractDSpaceRestRepository
    ...
    public ItemRest getEditItemItem(@Nullable HttpServletRequest request, UUID id,
