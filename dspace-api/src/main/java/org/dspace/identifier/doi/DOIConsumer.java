    ...
    public void consume(Context ctx, Event event) throws Exception {
        ...
        catch (IdentifierNotFoundException ex)
        {
            log.warn("DOIConsumer cannot handles items without DOIs, skipping: "
                    + event.toString());
            //When items is IN ARCHIVED, then the item could have or not a DOI generated by the DOIIdentifierProvider (i.e. the item
            //being updated is older than the doi provider activation date at repository, or the DOI was not generated for an item  because
            //it was filtered), then later exceptions happens and unnecessary logs are registered. To avoid this, finalize consumer at this point...
            return;
        }
        try
        {
