...
public class GoogleMetadata
{
    ...
    protected  static final String DATE = "citation_publication_date";
    
    protected  static final String ONLINE_DATE ="citation_online_date";
    ...
    /* SEDICI-BEGIN */ 
    protected static final String CONFERENCE = "citation_conference_title";
    /* SEDICI-END */
