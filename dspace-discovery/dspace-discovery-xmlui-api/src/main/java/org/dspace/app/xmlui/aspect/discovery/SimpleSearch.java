...
//        searchList.setHead(T_search_label);
        ...
        //SEDICI remove the escaping slashes added to the query for the brackets
        ...
        //SEDICI Se comento esta linea para cuando se realiza una nueva busqueda, no tenga en cuentas los demas filtros, solo el del paramtro query
...
//        query.addPara(null, "button-list").addButton("submit").setValue(T_go);
    ...
    protected String getQuery() throws UIException {
        ...
        //SEDICI deal with brackets in the main query
